...
#                     for seed in {0..9}
#                     do
#                     python train_gnn.py --database "DC_combined" --comb_type "prod_fc" --conv $conv --neg_dataset $neg_dataset --ce_lr $ce_lr --contra_lr $contra_lr --train_mode $train_mode --seed $seed --device 0 --wandb
#                     done
#                 done
#             done
#         done
